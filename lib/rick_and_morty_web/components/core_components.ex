defmodule RickAndMortyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RickAndMortyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RickAndMortyWeb.Gettext, "errors", msg, opts)
    end
  end
